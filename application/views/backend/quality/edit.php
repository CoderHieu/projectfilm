      ...
      <div class="box box-primary">
        ...
        <form id="frm-admin" method="post" action="">
          <div class="box-body">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" value="<?php if(isset($quality['name']) && $quality['name']!=''){ echo $quality['name']; }?>">
                </div>
            </div>
            <div class="form-group">
                <?php if($quality['publish'] == 0){ ?>
          ...
          <div class="box-footer">
            ...
            <a href="admin/quality/index" class="btn btn-success btn-flat"><span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span> Trở về</a>
          </div>
        </form>
      </div>
    </div>
